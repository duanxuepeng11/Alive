...
f= requests.get(url)  #get方法获取改网页的内容
#print(f.text)  #获取文件的内容,content获取的是二进制的文件内容
...
for k in soup.find_all('div',class_='pl2'):#,找到div并且class为pl2的标签
    ...
    print(a)            #取第一组的span中的字符串

"""
[<a class="" href="https://movie.douban.com/subject/26715636/">
                        地久天长
                        / <span style="font-size:13px;">So Long, My Son</span>
</a>]
"""
